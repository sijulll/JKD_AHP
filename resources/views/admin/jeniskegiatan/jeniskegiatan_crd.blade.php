        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="table_kriteria" class="table table-bordered table-hover">
              ...
              <tr class="jeniskegiatan{{$jeniskegiatan->id}}">
              <td>{{ $no++ }}</td>
              <td>{{$jeniskegiatan->nama_jk}}</td>
...
<div class="modal fade" id="modal-create">
    ...
    <form action="{{route('admin.jeniskegiatan.store')}}" method="POST">
            {{ csrf_field() }}
        <div class="modal-body">
        <div class="form-group">
            <label for="nama_jk">Nama Jenis Kegiatan</label>
            <input type="text" class="form-control" id="nama_jk" name="nama_jk" placeholder="Nama Jenis Kegiatan">
        </div>
        <div class="form-group">
