            ...
            <table id="table_kriteria" class="table table-bordered table-hover">
              ...
              <td>{{$komponenkegiatan->deskripsi}}</td>
                <td>
                    ...
                    <form action="{{ route('admin.komponenkegiatan.destroy', $komponenkegiatan->id) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
                <a href="{{ route('admin.komponenkegiatan.edit',$komponenkegiatan->id)}}" class="btn btn-warning show-modal" data-id="{{$komponenkegiatan->id}}" data-nama="{{$komponenkegiatan->nama_kegiatan}}" data-deskripsi="{{$komponenkegiatan->deskripsi}}" >
                        Edit
                </a>
                    <button type="submit" data-id="{{$komponenkegiatan->id}}" data-nama="{{$komponenkegiatan->nama_kegiatan}}" data-deskripsi="{{$komponenkegiatan->deskripsi}}" class="btn btn-danger" >
                        Delete
                    </button>
                    </form>
                </td>
...
<div class="modal fade" id="modal-create">
    ...
    <form action="{{route('admin.komponenkegiatan.store')}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" placeholder="Nama Jenis Kegiatan">
        </div>
        <div class="form-group">
            <label for="kegiatan_point">Poin Kegiatan</label>
            <input type="text" class="form-control" id="kegiatan_point" name="kegiatan_point" placeholder="Kegiatan Point">
        </div>
        <div class="form-group">
